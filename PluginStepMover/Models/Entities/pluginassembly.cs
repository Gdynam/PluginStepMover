...
namespace PluginStepMover.Models
{
	...
	public partial class PluginAssembly : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.PluginType> pluginassembly_plugintype
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.PluginType>("pluginassembly_plugintype", null);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.PluginType>("pluginassembly_plugintype", null, value);
			}
		}
	}
}
