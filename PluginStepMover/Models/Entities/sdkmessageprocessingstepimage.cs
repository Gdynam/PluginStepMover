...
namespace PluginStepMover.Models
{
	...
	public partial class SdkMessageProcessingStepImage : Microsoft.Xrm.Sdk.Entity
	{
		...
		public PluginStepMover.Models.SdkMessageProcessingStep sdkmessageprocessingstepid_sdkmessageprocessingstepimage
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.SdkMessageProcessingStep>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null);
			}
			set
			{
				this.SetRelatedEntity<PluginStepMover.Models.SdkMessageProcessingStep>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null, value);
			}
		}
	}
}
