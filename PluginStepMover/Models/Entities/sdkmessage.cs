...
namespace PluginStepMover.Models
{
	...
	public partial class SdkMessage : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.SdkMessageFilter> sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.SdkMessageFilter>("sdkmessageid_sdkmessagefilter", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.SdkMessageProcessingStep> sdkmessageid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("sdkmessageid_sdkmessageprocessingstep", null, value);
			}
		}
	}
}
