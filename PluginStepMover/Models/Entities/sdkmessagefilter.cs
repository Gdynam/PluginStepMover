...
namespace PluginStepMover.Models
{
	...
	public partial class SdkMessageFilter : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.SdkMessageProcessingStep> sdkmessagefilterid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public PluginStepMover.Models.SdkMessage sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.SdkMessage>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.SetRelatedEntity<PluginStepMover.Models.SdkMessage>("sdkmessageid_sdkmessagefilter", null, value);
			}
		}
	}
}
