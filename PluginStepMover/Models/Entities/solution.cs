...
namespace PluginStepMover.Models
{
	...
	public partial class Solution : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.Solution> Referencedsolution_parent_solution
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.Solution>("solution_parent_solution", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.Solution>("solution_parent_solution", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
			}
		}
		...
		public PluginStepMover.Models.Solution Referencingsolution_parent_solution
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.Solution>("solution_parent_solution", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
}
