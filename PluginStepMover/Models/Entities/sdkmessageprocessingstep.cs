...
namespace PluginStepMover.Models
{
	...
	public partial class SdkMessageProcessingStep : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.SdkMessageProcessingStepImage> sdkmessageprocessingstepid_sdkmessageprocessingstepimage
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStepImage>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStepImage>("sdkmessageprocessingstepid_sdkmessageprocessingstepimage", null, value);
			}
		}
		...
		public PluginStepMover.Models.PluginType plugintype_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.PluginType>("plugintype_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntity<PluginStepMover.Models.PluginType>("plugintype_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public PluginStepMover.Models.PluginType plugintypeid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.PluginType>("plugintypeid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntity<PluginStepMover.Models.PluginType>("plugintypeid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public PluginStepMover.Models.SdkMessageFilter sdkmessagefilterid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.SdkMessageFilter>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntity<PluginStepMover.Models.SdkMessageFilter>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public PluginStepMover.Models.SdkMessage sdkmessageid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.SdkMessage>("sdkmessageid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntity<PluginStepMover.Models.SdkMessage>("sdkmessageid_sdkmessageprocessingstep", null, value);
			}
		}
	}
}
