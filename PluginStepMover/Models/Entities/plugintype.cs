...
namespace PluginStepMover.Models
{
	...
	public partial class PluginType : Microsoft.Xrm.Sdk.Entity
	{
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.SdkMessageProcessingStep> plugintype_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("plugintype_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public System.Collections.Generic.IEnumerable<PluginStepMover.Models.SdkMessageProcessingStep> plugintypeid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.SetRelatedEntities<PluginStepMover.Models.SdkMessageProcessingStep>("plugintypeid_sdkmessageprocessingstep", null, value);
			}
		}
		...
		public PluginStepMover.Models.PluginAssembly pluginassembly_plugintype
		{
			get
			{
				return this.GetRelatedEntity<PluginStepMover.Models.PluginAssembly>("pluginassembly_plugintype", null);
			}
			set
			{
				this.SetRelatedEntity<PluginStepMover.Models.PluginAssembly>("pluginassembly_plugintype", null, value);
			}
		}
	}
}
